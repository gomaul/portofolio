...
spareImg?: string;
  ...
  const handleCopy=() => {
    navigator.clipboard.writeText('gomaul161@gmail.com');
          ...
          {id === 3 && (
            ...
            <div className="flex gap-1 lg:gap-4 w-fit absolute -right-3 lg:-right-2">
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-4">
                  ...
                  ((item) =>(
                    <span key={item} className="py-2 lg:py-3 lg:px-3 px-3 text-xs lg:text-base opacity-50
